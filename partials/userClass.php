...
//            $prepared = mysqli_prepare($this->conn, "insert into users set id = ?, name = ?, email = ?, password = ?, role = ?, image_name = ?, created_at = ?");
//            mysqli_stmt_bind_param($prepared, "isssiss", $idForNewUser, $un, $em, $pwForDB, $role, $image_name, $createdAt);
